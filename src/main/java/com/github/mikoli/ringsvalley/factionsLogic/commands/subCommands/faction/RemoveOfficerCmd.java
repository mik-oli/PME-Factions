...
public class RemoveOfficerCmd extends ISubCommand {

    private final RVFactions plugin;

    public RemoveOfficerCmd(RVFactions plugin) {
        this.plugin = plugin;
    }
    ...
    public String getSyntax() {
        return "/factions demote <player>";
    }

    @Override
    public String getAdminSyntax() {
        return "/factions-admin demote <faction> <player>";
    }
